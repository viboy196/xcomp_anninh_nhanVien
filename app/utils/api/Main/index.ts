...
import axios, { Unauthorized, urlActivateApp, urlDetail ,urlGetTienichAnninhByNguoidung} from "../apiLink";
...
export const GetListCongviecBySystemAnninh = async (data:{token:string}):Promise<ExcuteResult> => {
